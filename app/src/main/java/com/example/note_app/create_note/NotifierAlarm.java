...
//        NoteModel reminder = new NoteModel(1,);
//        reminder.setNote(intent.getStringExtra("Message"));
...
//        AppDatabase.destroyInstance();
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            channel = new NotificationChannel("my_channel_01"+id,title, NotificationManager.IMPORTANCE_HIGH);
        }
